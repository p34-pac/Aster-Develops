...
function Footer({navigate, menu}) {
  return (
    <footer className={menu=="max"?"footer max":"footer min"}>
        <nav>
            <a onClick={()=>navigate("Projects")}>Project</a>
            <a onClick={()=>navigate("About")}>About</a>
            <a onClick={()=>navigate("Contact")}>Contact</a>
            <a onClick={()=>navigate("Blogs")}>Blogs</a>
        </nav>
        <section className="reference">
            <div className="ref_cont">
                <a href="mailto:peterpaultolulope@gmail.com">peterpaultolulope@gmail.com</a>
                <a href="tel:+2348109080838">+234-810-908-0838</a>
            </div>
            <i className="ic-RP">
